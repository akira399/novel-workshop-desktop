...
import { LoreMatcher, LoreService, LoreStore } from '../src/lorebook/index.ts'

const ASSETS_DIR = join(dirname(fileURLToPath(import.meta.url)), '..', '..', '..', 'resources', 'samples', 'demo-book', 'lorebook')
